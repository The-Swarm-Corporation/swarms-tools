...
class MCPClient:
    ...
    async def connect_to_server(self, server_script_path="./swarms_tools/finance/defillama_mcp_tools.py"):
...
async def test_client():
    ...
    try:
        ...
        print(f"Result: {protocols_result.content[:500]}...")  # Truncate for readability
        
        # Call get_token_prices with a token
        print("\nCalling get_token_prices...")
        token_result = await client.call_tool("get_token_prices", {"token": "ethereum:0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2"})
        print(f"Result: {token_result.content[:500]}...")  # Truncate for readability
